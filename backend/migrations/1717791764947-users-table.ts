...
export class UsersTable1717791764947 implements MigrationInterface {
  name = 'UsersTable1717791764947';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "student_user_model" ("student_id" integer NOT NULL, CONSTRAINT "PK_956586c752a952c56b0274a5344" PRIMARY KEY ("student_id"))`,
    );
    await queryRunner.query(
