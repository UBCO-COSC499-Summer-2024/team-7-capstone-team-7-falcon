...
### Current Tasks (Provide sufficient detail and include t-shirt size)
  ...
  * #2: Create Join course frontend api [XS]
  * #3: Instructor create exam page [S]
...
<table>
    ...
    <tr>
        <!-- Task/Issue # -->
        <td>Create Join course frontend api 
        </td>
        <!-- Status -->
        <td>Complete
        </td>
    ...
    <tr>
        <!-- Task/Issue # -->
        <td>Instructor create exam page
        </td>
        <!-- Status -->
        <td>In Progress
        </td>
...
I completed task 1,2 almost finished task 3. Overall it is a bit unclear what tasks need to be worked on or are being worked on
