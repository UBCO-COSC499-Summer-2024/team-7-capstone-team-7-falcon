...
- OMR pipeline
- Updating frontend FAQs

## Associated Tasks from Project Board

!["tasks_this_cycle_08.07_08.08"](images/this_cycle/tasks_this_cycle_08.07_08.08.png)
...
NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for Aug 8 - Aug 9 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)

### This cycle

!["This_cycle_burn_up_chart"](images/burn_up_chart/this_cycle/burn_up_this_cycle_08.07_08.08.png)

### Overall

!["Overall_burn_up_chart_so_far"](images/burn_up_chart/overall/burn_up_overall_08.07_08.08.png)

## Times for Team/Individual

!["time-tracking"](images/clockify/clockify_08.07_08.08.png)

## Completed Tasks

!["completed_this_cycle"](images/completed/completed_08.07_08.08.png)
...
!["unit_tests_backend_08.07_08.08"](images/testing/unit_tests_backend_08.07_08.08.png)

Backend integration tests.

!["integration_tests_backend_08.07_08.08"](images/testing/integration_tests_backend_08.07_08.08.png)

Python tests for OMR system

!["python_tests_08.07_08.08"](images/testing/python_tests_08.07_08.08.png)

## Overview

Development is complete. The next step is for the team to take some time off.
...
- Test-O-rama action items
- Updating frontend FAQs

## Associated Tasks from Project Board

!["tasks_this_cycle_08.02_08.06"](images/this_cycle/tasks_this_cycle_08.02_08.06.png)

## Tasks for Next Cycle

!["tasks_next_cycle_08.02_08.06"](images/next_cycle/tasks_next_cycle_08.02_08.06.png)

- Prep for final presentation

## Burn-up Chart (Velocity)

NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for Aug 3 - Aug 7 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)

### This cycle

!["This_cycle_burn_up_chart"](images/burn_up_chart/this_cycle/burn_up_this_cycle_08.02_08.06.png)

### Overall

!["Overall_burn_up_chart_so_far"](images/burn_up_chart/overall/burn_up_overall_08.02_08.06.png)

## Times for Team/Individual

!["time-tracking"](images/clockify/clockify_08.02_08.06.png)

## Completed Tasks

!["completed_this_cycle"](images/completed/completed_08.02_08.06.png)

## In Progress Tasks/ To do

!["todo_08.02_08.06"](images/next_cycle/tasks_next_cycle_08.02_08.06.png)
...
!["unit_tests_backend_08.02_08.06"](images/testing/unit_tests_backend_08.02_08.06.png)

Backend integration tests.

!["integration_tests_backend_08.02_08.06"](images/testing/integration_tests_backend_08.02_08.06.png)

Python tests for OMR system

!["python_tests_08.02_08.06"](images/testing/python_tests_08.02_08.06.png)

## Overview

The team has mostly wrapped up development and the application is now deployed on the UBC server. We are now working on completing our individual reports and prepping for the final presentation.
...
- OMR
  ...
  - Integrate endpoints for OMR payload returns with the pipeline
- Allow for the modification of bubble sheet answers
- Documentation updates
- Usability fixes and bug fixes

## Associated Tasks from Project Board

!["tasks_this_cycle_07.31_08.01"](images/this_cycle/tasks_this_cycle_07.31_08.01.png)

## Tasks for Next Cycle

!["tasks_next_cycle_07.31_08.01"](images/next_cycle/tasks_next_cycle_07.31_08.01.png)

## Burn-up Chart (Velocity)

NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for Aug 1 - Aug 2 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)

### This cycle

!["This_cycle_burn_up_chart"](images/burn_up_chart/this_cycle/burn_up_this_cycle_07.31_08.01.png)

### Overall

!["Overall_burn_up_chart_so_far"](images/burn_up_chart/overall/burn_up_overall_07.31_08.01.png)

## Times for Team/Individual

!["time-tracking"](images/clockify/clockify_07.31_08.01.png)

## Completed Tasks

!["completed_this_cycle"](images/completed/completed_07.31_08.01.png)

## In Progress Tasks/ To do

!["todo_07.31_08.01"](images/next_cycle/tasks_next_cycle_07.31_08.01.png)

## Test Report / Testing Status

Backend unit tests. Note that the red tests are files that are covered by integration tests that are not reported.

!["unit_tests_backend_07.31_08.01"](images/testing/unit_tests_backend_07.31_08.01.png)

Backend integration tests.

!["integration_tests_backend_07.31_08.01"](images/testing/integration_tests_backend_07.31_08.01.png)

Python tests for OMR system

!["python_tests_07.31_08.01"](images/testing/python_tests_07.31_08.01.png)

## Overview

This cycle, the team continued to work towards completing the features required for the test-o-rama. We are wrapping up development and will focus on testing and deployment in the next cycle.
...
- OMR
  ...
  - Structure for recording grades
  - Integrate endpoints for OMR payload returns with the pipeline
- Allowing for multiple answers in a question (bubble sheet creation)
- Allowing students to contest grading results
- Hide exam grades
- Allow professor to change submission user
- Allow for the modification of bubble sheet answers
- Documentation updates
- Usability fixes
...
!["tasks_this_cycle_07.26_07.30"](images/this_cycle/tasks_this_cycle_07.26_07.30.png)

## Tasks for Next Cycle

!["tasks_next_cycle_07.26_07.30"](images/next_cycle/tasks_next_cycle_07.26_07.30.png)

## Burn-up Chart (Velocity)

NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for July 27 - July 31 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)

### This cycle

!["This_cycle_burn_up_chart"](images/burn_up_chart/this_cycle/burn_up_this_cycle_07.26_07.30.png)

### Overall

!["Overall_burn_up_chart_so_far"](images/burn_up_chart/overall/burn_up_overall_07.26_07.30.png)

## Times for Team/Individual

!["time-tracking"](images/clockify/clockify_07.26_07.30.png)

## Completed Tasks

!["completed_this_cycle"](images/completed/completed_07.26_07.30.png)

## In Progress Tasks/ To do

!["todo_07.26_07.30"](images/next_cycle/tasks_next_cycle_07.26_07.30.png)

## Test Report / Testing Status

Backend unit tests. Note that the red tests are files that are covered by integration tests that are not reported.

!["unit_tests_backend_07.26_07.30"](images/testing/unit_tests_backend_07.26_07.30.png)

Backend integration tests.

!["integration_tests_backend_07.26_07.30"](images/testing/integration_tests_backend_07.26_07.30.png)

Python tests for OMR system

!["python_tests_07.26_07.30"](images/testing/python_tests_07.26_07.30.png)

## Overview

This cycle, the team continued to work towards completing the features required for the test-o-rama. Significant time was spent on the OMR pipeling and integration with the rest of the system.  Next cycle, we will focus on testing the system in preparation for Friday's testing exercise.
...
- Frontend
  ...
  - Remove students from a course
  - Update student join course page
- OMR
  - Integrate OpenCV utilities into the pipeline
  - Structure for recording grades
  - Add identifiers to pages
- Allowing for multiple answers in a question (bubble sheet creation)
- Documentation updates
- Usability fixes
...
!["tasks_this_cycle_07.24_07.25"](images/this_cycle/tasks_this_cycle_07.24_07.25.png)

## Tasks for Next Cycle

!["tasks_next_cycle_07.24_07.25"](images/next_cycle/tasks_next_cycle_07.24_07.25.png)

## Burn-up Chart (Velocity)

NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for July 25 - July 26 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)

### This cycle

!["This_cycle_burn_up_chart"](images/burn_up_chart/this_cycle/burn_up_this_cycle_07.24_07.25.png)

### Overall

!["Overall_burn_up_chart_so_far"](images/burn_up_chart/overall/burn_up_overall_07.24_07.25.png)

## Times for Team/Individual

!["time-tracking"](images/clockify/clockify_07.24_07.25.png)

## Completed Tasks

!["completed_this_cycle"](images/completed/completed_07.24_07.25.png)

## In Progress Tasks/ To do

!["todo_07.24_07.25"](images/next_cycle/tasks_next_cycle_07.24_07.25.png)

## Test Report / Testing Status

Backend unit tests. Note that the red tests are files that are covered by integration tests that are not reported.

!["unit_tests_backend_07.24_07.25"](images/testing/unit_tests_backend_07.24_07.25.png)

Backend integration tests.

!["integration_tests_backend_07.24_07.25"](images/testing/integration_tests_backend_07.24_07.25.png)

Python tests for OMR system

!["python_tests_07.24_07.25"](images/testing/python_tests_07.24_07.25.png)

## Overview

This cycle, the team focused on completing the features required for the test-o-rama. We also reviewed the list of requirements for the project. Overall, progress is going well and the next steps would be to prep for the testing session next Friday.
