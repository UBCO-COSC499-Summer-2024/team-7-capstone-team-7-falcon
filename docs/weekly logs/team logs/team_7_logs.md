...
This cycle, the team worked on analysing the results (see `../../peer-testing-round-1`) from the peer testing exercise as well as addressing issues brought up during the exercise.

[Talk about additional requirements and how we are addressing these]
