...
NOTE (1): We noticed a bug in the chart generated by GitHub so these might not be very accurate. We had to generate the chart for July 24 - July 26 to get the correct number of completed items. (The issues related to documentation have been filtered out this time.)
