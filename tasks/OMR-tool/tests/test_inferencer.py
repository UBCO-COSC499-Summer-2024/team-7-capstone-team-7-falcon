...
class TestInferencer:
    """
    A test class for the `Inferencer` class.
    """
    ...
    def test_preprocess_image(self, inferencer, image):
    ...
    def test_postprocess_results(self, inferencer):
    ...
    def test_inference(self, inferencer, image):
